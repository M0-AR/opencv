...
# Highlight dissimilar areas in the tampered image
highlighted = tampered.copy()
for contour in contours:
    cv2.drawContours(highlighted, [contour], -1, (0, 255, 0), 3)
...
def display_images(images, titles, cmap=None):
    ...
    for i, image in enumerate(images):
        ax = axs.flatten()[i] if n > 2 else axs[i]
...
images = [original, tampered, diff, highlighted]
titles = ["Original Image", "Tampered Image", "Difference Image", "Highlighted Differences"]
